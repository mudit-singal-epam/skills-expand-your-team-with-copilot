...
def get_activities(
    ...
    - difficulty: Filter activities by difficulty level ('Beginner', 'Intermediate', 'Advanced', or 'none' for no difficulty)
    """
    ...
    if difficulty:
        if difficulty == "none":
            # "none" means activities with no specified difficulty
