...
def get_activities(
    ...
    - difficulty: Filter activities by difficulty level ('Beginner', 'Intermediate', 'Advanced', or 'all' for no difficulty)
    """
    ...
    if difficulty:
        if difficulty == "all":
            # "all" means activities with no specified difficulty
